ActiveAdmin.register Welcome do
  ...
  #
   permit_params :title, :logoimg, :desc, :whatsapp, :ig, :ln, :section, :link, :footer, :phone, :address, :twitter, :email, :youtube, :telegram, :bgimg
  #
  # or
  #
  # permit_params do
  #   permitted = [:title, :logoimg, :desc, :whatsapp, :ig, :ln, :section, :link, :footer, :phone, :address, :twitter, :email, :youtube, :telegram, :bgimg]
